...
<section class="hero">
    ...
    <?php foreach ( $hero_background as $idx => $url ) :
        if ( ! $url ) {
            continue; // on skip si pas d'image
        }
    ?>
        <div
    ...
    <div class="hero__contenu global">
        ...
        <?php if ( $hero_courriel ) : ?>
            <p class="hero__courriel">
                Courriel : <?php echo esc_html( $hero_courriel ); ?>
            </p>
        <?php endif; ?>
        ...
        <div class="hero__icone-app">
            <img
                src="https://s2.svgbox.net/social.svg?ic=facebook&color=<?php echo esc_attr( $couleur_icon ); ?>"
                width="20"
                height="20"
                alt="Facebook"
            >
            <img
                src="https://s2.svgbox.net/social.svg?ic=linkedin&color=<?php echo esc_attr( $couleur_icon ); ?>"
                width="20"
                height="20"
                alt="LinkedIn"
            >
            <img
                src="https://s2.svgbox.net/social.svg?ic=paypal&color=<?php echo esc_attr( $couleur_icon ); ?>"
                width="20"
                height="20"
                alt="PayPal"
            >
            <img
                src="https://s2.svgbox.net/social.svg?ic=stackoverflow&color=<?php echo esc_attr( $couleur_icon ); ?>"
                width="20"
                height="20"
                alt="Stack Overflow"
            >
